        ...
        <div className="dashboard__body">
          ...
          <div className="dashboard__section">
            ...
            <div className="dashboard__activity-grid card">
              {[
                { icon: FiPackage, label: 'Active Listings', value: stats.listings, to: '/my-listings', color: 'var(--color-blue)' },
                { icon: FiTrendingUp, label: 'Completed Sales', value: stats.sales ?? 0, to: '/my-listings', color: 'var(--color-green-text)' },
                { icon: FiCheckCircle, label: 'Purchases', value: stats.purchases ?? 0, to: '/purchases', color: 'var(--color-orange-text)' },
              ].map((a) => (
                <button
                  key={a.label}
